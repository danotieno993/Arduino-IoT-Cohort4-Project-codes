...
constexpr char WIFI_SSID[] PROGMEM = "Eng Otieno - R";
constexpr char WIFI_PASSWORD[] PROGMEM = "5Aim95AnRgb";
#else
constexpr char WIFI_SSID[] = "Eng Otieno - R";
constexpr char WIFI_PASSWORD[] = "5Aim95AnRgb";
#endif
...
#else
constexpr char TOKEN[] = "lcP7viViOyzDsJXQidvt";
#endif
