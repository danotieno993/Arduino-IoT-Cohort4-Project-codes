//===========ESP8266 Access Point to Control  3LEDs==============
...
<html>
  <head>
    <title>Switching LEDs</title>
  </head>
  <body>
    <h1>Switch the LEDs</h1>
    <p><a href=/ledon>LEDs ON</a></p>
    <p><a href=/ledoff>LEDs OFF</a></p>
  </body>
</html>

)***";

// Define the pin leds are connected
#define red_led D0
...
ESP8266WebServer server(80);  //a pointer to be used as gateway to browser on http port 80
